...
#
# Autor: [Sebastían Navarrete Poblete]
# Fecha: [25-08-2026]
#
...
es_capital <- TRUE                    # logical: ¿Ñuble es capital regional? TRUE/FALSE
fecha_censo <- as.Date("09-03-2024")        # Date: usa el formato "AAAA-MM-DD"
...
length(salario)     # ¿cuántos elementos?
length(educ)        # ¿coinciden los largos?
...
# RESPUESTA: Los datos estan muy "separados" entre otros por lo que la media
# y la mediana varian bastante. Tendra que tener relacion con la desigualdad entre
# salarios.
print(salario)
#
...
# [1] 450000 920000 380000 510000 280000 1250000
#



# TODO: responde en comentarios:
# ¿Funcionó a la primera? no
# ¿Usó la misma forma que aprendiste en el PASO 4, u otra distinta? SI
# ¿Entiendes cada parte de lo que te dio? Si no, ¿qué parte no? No, no habia entendido  
# Lo de "vector" luego entendi que se referia al salario pero eso fue porque no le di el
# contexto de que vector estaba trabajando
...
#
# MI PREGUNTA: En que años el salario real fue menor que el nominal en mas de 
# 100000?
anios[salario- salario_real > 100000] 
...
# -----------------------------------------------------------------------------
# [Check] No quedan ____ sin completar.
# [Check] El script corre completo de una vez (reinicia R y córrelo entero).
# [Check] Verifiqué los tipos antes de calcular.
# [Check] Respondí las dos preguntas guía en los comentarios.
# [Check] Documenté el resultado de la consulta a ChatGPT.
